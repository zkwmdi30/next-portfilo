...
export default function Home() {
  return (
    <main className="max-w-4xl pt-28 text-gray-300 mx-auto">
      <section className="text-yellow-500 text-4xl md:text-7xl font-bold m-16 leading-normal">
        <div className="flex flex-row items-center">
          <div className="absolute z-10 image-container mr-4 mb-40 opacity-75">
            <Image className="face" src="/images/face.JPG" width={200} height={200} alt="얼굴" />
          </div>
